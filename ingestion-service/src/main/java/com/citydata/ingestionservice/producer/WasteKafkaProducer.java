...
@Service
public class WasteKafkaProducer extends KafkaProducer {
    @Value("${kafka.topics.waste}") // Load from config
    private String topic;

    public WasteKafkaProducer(KafkaTemplate<String, String> kafkaTemplate, ObjectMapper objectMapper) {
