...
@Service
public class ElectricityKafkaProducer extends KafkaProducer {
    @Value("${kafka.topics.electricity}") // Load from config
    private String topic;

    public ElectricityKafkaProducer(KafkaTemplate<String, String> kafkaTemplate, ObjectMapper objectMapper) {
